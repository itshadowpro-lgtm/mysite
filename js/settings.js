...
const musicOptions = [
    ...
    { value: 'audio/postcardnam.mp3', label: 'Happy Birthday Podcast (Nam)' },
    { value: 'audio/podcardnu.mp3', label: 'Happy Birthday Podcast (Nữ)' },
    { value: 'audio/givemeyourforever.mp3', label: 'Give Me Your Forever' },
    { value: 'audio/perfect.mp3', label: 'Perfect' },
    { value: 'audio/phepmau.mp3', label: 'Phép màu' },
    { value: 'audio/lambantraianhe.mp3', label: 'Làm bạn trai anh nhé' },
    { value: 'audio/denbenanh.mp3', label: 'Đến bên anh' },
    { value: 'audio/anhnangcuaanh.mp3', label: 'Ánh nắng của anh' },
    { value: 'audio/dunglamtraitimanhdau.mp3', label: 'Đừng làm trái tim anh đau' },
    { value: 'audio/buiphan.mp3', label: 'Bụi phấn' },
    { value: 'audio/buocnhevaotimanh.mp3', label: 'Bước nhẹ vào tim anh' },
    { value: 'audio/codoidieu.mp3', label: 'Có đôi điều' },
    { value: 'audio/coem.mp3', label: 'Có em' },
    { value: 'audio/emnay.mp3', label: 'Em này' },
    { value: 'audio/emlacogiaovungcao.mp3', label: 'Em là cô giáo vùng cao' },
    { value: 'audio/emlacogiaovungcaoremix.mp3', label: 'Em là cô giáo vùng cao (Remix)' },
    { value: 'audio/lathuguithay.mp3', label: 'Lá thư gửi thầy' },
    { value: 'audio/loithayco.mp3', label: 'Lời thầy cô' },
    { value: 'audio/nguoithay.mp3', label: 'Người thầy' },
    { value: 'audio/nguoigieomamxanh.mp3', label: 'Người gieo mầm xanh' },
    { value: 'audio/nguoidautien.mp3', label: 'Người đầu tiên' },
    { value: 'audio/motdoi.mp3', label: 'Một đời' },
    { value: 'audio/minhcungnhaudongbang.mp3', label: 'Mình cùng nhau đóng băng' },
    { value: 'audio/neunhucohaitraitim.mp3', label: 'Nếu như có hai trái tim' },
    { value: 'audio/ngayxuaay.mp3', label: 'Ngày xưa ấy' },
    { value: 'audio/Như 1 vì tinh tú.mp3', label: 'Như 1 vì tinh tú' },
    { value: 'audio/tinhyeudieuky.mp3', label: 'Tình yêu diệu kỳ' },
    { value: 'audio/trentinhbanduoitinhyeu.mp3', label: 'Trên tình bạn dưới tình yêu' },
    { value: 'audio/tungngayyeuem.mp3', label: 'Từng ngày yêu em' },
    { value: 'audio/yeuemratnhieu.mp3', label: 'Yêu em rất nhiều' },
    { value: 'audio/suynghitronganh.mp3', label: 'Suy nghĩ trong anh' }
];
const gifOptions = [
    { value: '', label: 'None' },
